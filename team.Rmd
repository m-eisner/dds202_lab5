...
## Data Background: FARS data
  ...
  * Load the two datasets.
  ...
  `acc <- read.csv("https://raw.githubusercontent.com/xdaiISU/ds202materials/master/hwlabs/fars2017/accident.csv", stringsAsFactors = FALSE) # repeat for the person data`
